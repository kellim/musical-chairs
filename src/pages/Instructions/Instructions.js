...
function Instructions(props) {
  ...
  return (
    <div className="Instructions">
      ...
      In a typical Musical Chairs game, players walk around a circle of chairs facing outward while music plays for a random but fairly 
      ...
      <p>On the Game Setup screen, in the <strong>Song</strong> dropdown select the song that will be played during the game and enter the following:</p>
      <ul className="Instructions-input-list">
        ...
        <li><strong>Min Play Time per Round</strong>  - Minmum amount of time (between 3 and 60 seconds) that the music should play in a round.</li>
        ...
        <li><strong>Delay Before Starting Game</strong>   - Amount of time (between 1 and 120 seconds) that should pass after the <strong>Let's Go</strong> button
         in Game Setup is clicked and before the music starts playing in the first round. This may be needed if a player needs to walk from a computer to the
        ...
        <p>After the music stops in a round, <strong>Wait!</strong> will be displayed in the app and players should try to sit in an empty
         ...
         from the game and remaining players can stand up around the chairs again and get ready to walk when the music starts again.</p>
        ...
        <p>The game continues like this until 2 players are the final round: the one who sits in the final chair after the music stops wins!</p>

        <h3>Start a New Game with New Options</h3>
        <p>After the game has started, click the <strong>Return to Game Setup</strong> button to end the current game and
        return to <strong>Game Setup</strong> to choose options for starting a new game.</p>
        <h3>Restarting the Game with the Same Options</h3>
        <p>After the game has started, click the <strong>Restart Game</strong> button to end the current game and
        start a new game right away with the same options as the game that was being played.</p>
      </div>
  )
}
